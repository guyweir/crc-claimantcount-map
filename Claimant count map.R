...
lsoa.centroids <- geojson_sp("https://opendata.arcgis.com/datasets/b7c49538f0464f748dd7137247bbc41c_0.geojson")
...
EWS.centroids.df <- merge(cc,EWS.centroids, by.y = "lsoa11cd",by.x = "lsoa11cd", all.x = T)
